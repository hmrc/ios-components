        ...
        public struct Model {
            ...
            public init(
                ...
                if let selectedImage = selectedImage {
                    ...
                    self.selectedImage = UIImage(named: "FilledCircle", in: Bundle.resource, compatibleWith: nil)?
                ...
                if let deselectedImage = deselectedImage {
                    ...
                    self.deselectedImage = UIImage(named: "EmptyCircle", in: Bundle.resource, compatibleWith: nil)?
                        .withRenderingMode(.alwaysTemplate)
                }
